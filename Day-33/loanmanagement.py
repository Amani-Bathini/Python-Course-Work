...
class Loan(ABC):
  ...
  def sanction_loan(self):
    if self.status == "Rejected":
      print("Loaan application was rejected")
      return
  ...
  def  repay(self,amount):
    ...
    print("Amount Paid amount  :",amount)
...
amani.display_customer()
print('Loan Eligibility:',amani.check_eligibility())
...
akhila.display_customer()
print('Loan Eligibility:',akhila.check_eligibility())
